...
function guessMediaType(url) {
    ...
    if (url.match(/video_player_tmpl&action=mpvideo/)) {
        return 'video';
    }
    if (url.match(/player\.bilibili\.com\/player\.html/)) {
        return 'video';
    }
...
function renderMedia(tokens, idx, options, env, md) {
    ...
    if (url.match(/player\.bilibili\.com\/player\.html/)) {
        return `<iframe height="450px" width="100%" src="${url}" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true">  </iframe>`
    ...
    // return `<iframe frameborder="0" src="https://v.qq.com/txp/iframe/player.html?vid=u3064p8fpln" allowFullScreen="true"></iframe>`
    // return `<iframe frameborder="0" width="640" height="498" src="${url}"></iframe>`

    // return `<iframe frameborder="0" src="https://mp.weixin.qq.com/mp/videoplayer?video_h=380.8125&video_w=677&scene=27&random_num=7677&article_title=%E5%80%9F%E5%8A%A9%20Live%20Caption%20%E5%9C%A8%E8%AE%BE%E5%A4%87%E4%B8%8A%E7%94%9F%E6%88%90%E5%AD%97%E5%B9%95&source=4&vid=wxv_1116545373650190337&mid=2247487226&idx=1&__biz=MzU1OTMyNDcxMQ==&nodetailbar=0&uin=&key=&pass_ticket=&version=/mmbizwap/zh_CN/htmledition/js/appmsg/index4bd003.js&devicetype=&wxtoken=777&sessionid=svr_5f12048374a&preview=0" allowFullScreen="true"></iframe>`
